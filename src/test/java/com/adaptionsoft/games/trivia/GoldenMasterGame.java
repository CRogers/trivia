...
import com.adaptionsoft.games.uglytrivia.StdoutPrinter;

import java.util.ArrayList;
import java.util.LinkedList;

public class GoldenMasterGame implements Game {
	...
	public GoldenMasterGame(Printer printer) {
